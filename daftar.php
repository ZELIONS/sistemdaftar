...
<body>
    <div class="container">
        <form action="back/daftar.php" method="post">
        ...
        <button class="btn btn-secondary custom-button"><a style="text-decoration:none; color:white" href="login.php">Masuk</a></button>
    </div>
